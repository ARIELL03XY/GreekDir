    ...
    <div className="h-full flex items-center justify-center p-8">
      <div className="text-center max-w-2xl w-full">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mb-3">
          Analiza el uso de tus discos
        </h2>
        <p className="text-sand-500 mb-8 leading-relaxed">
          Selecciona un disco o carpeta para visualizar cómo se distribuye el espacio.
          GreekDir te mostrará un mapa interactivo con todos tus archivos.
        </p>
