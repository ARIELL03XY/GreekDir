    ...
    <div className="h-full flex items-center justify-center p-8">
      <div className="text-center max-w-2xl w-full">
        ...
        <div className="grid grid-cols-3 gap-6 text-left">
          <div className="p-4 rounded-xl bg-surface border border-cream-300">
            ...
            <h3 className="font-medium text-sm text-ink-soft">{t('welcome.featureTreemap')}</h3>
            <p className="text-xs text-sand-500 mt-1">{t('welcome.featureTreemapDescription')}</p>
          </div>
          <div className="p-4 rounded-xl bg-surface border border-cream-300">
            <div className="w-8 h-8 rounded-lg bg-green-50 dark:bg-green-500/10 flex items-center justify-center mb-3">
              <svg className="w-4 h-4 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 12h16m-7 6h7" />
              </svg>
            </div>
            <h3 className="font-medium text-sm text-ink-soft">{t('welcome.featureList')}</h3>
            <p className="text-xs text-sand-500 mt-1">{t('welcome.featureListDescription')}</p>
          </div>
          <div className="p-4 rounded-xl bg-surface border border-cream-300">
            <div className="w-8 h-8 rounded-lg bg-purple-50 dark:bg-purple-500/10 flex items-center justify-center mb-3">
              <svg className="w-4 h-4 text-purple-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
              </svg>
            </div>
            <h3 className="font-medium text-sm text-ink-soft">{t('welcome.featureBrowse')}</h3>
