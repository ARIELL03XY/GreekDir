...
const translations: Record<Language, TranslationDictionary> = {
  en: {
    ...
    'results.byCategory': 'By file type',
    'results.export': 'Export',
    'results.exported': 'Saved ✓',
    'results.searchPlaceholder': 'Search everywhere…',
  ...
  es: {
    ...
    'results.byCategory': 'Por tipo de archivo',
    'results.export': 'Exportar',
    'results.exported': 'Guardado ✓',
    'results.searchPlaceholder': 'Buscar en todo…',
